...
class Client
{
  ...
  /**
   * @var \Google\Auth\AbstractAuth $auth
   */
  private $auth;

  /**
   * @var \Google\IO\AbstractIO $io
   */
  private $io;

  /**
   * @var \Google\Cache\AbstractCache $cache
   */
  private $cache;
   ...
   * @param \Google\Auth\AbstractAuth $auth
   */
  public function setAuth(\Google\Auth\AbstractAuth $auth)
  {
  ...
  /**
   * Set the IO object
   * @param \Google\IO\AbstractIO $auth
   */
  public function setIo(\Google\IO\AbstractIO $io)
  {
   ...
   * @param \Google\Cache\AbstractCache $auth
   */
  public function setCache(\Google\Cache\AbstractCache $cache)
  {
  ...
  /**
   * @return \Google\Auth\AbstractAuth Authentication implementation
   */
  ...
  /**
   * @return \Google\IO\AbstractIO IO implementation
   */
  ...
  /**
   * @return \Google\Cache\AbstractCache Cache implementation
   */
