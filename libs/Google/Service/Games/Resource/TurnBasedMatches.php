...
class TurnBasedMatches extends \Google\Resource\Service
{
   ...
   * @return \Google\Service\Games\TurnBasedMatch
   */
  public function create(\Google\Service\Games\TurnBasedMatchCreateRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), 'Google\Service\Games\TurnBasedMatch');
  }
  /**
  ...
  public function decline($matchId, $optParams = array())
  {
    $params = array('matchId' => $matchId);
    $params = array_merge($params, $optParams);
    return $this->call('decline', array($params), 'Google\Service\Games\TurnBasedMatch');
  }
  /**
   ...
   * @return \Google\Service\Games\TurnBasedMatch
   */
  public function finish($matchId, \Google\Service\Games\TurnBasedMatchResults $postBody, $optParams = array())
  {
    $params = array('matchId' => $matchId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('finish', array($params), 'Google\Service\Games\TurnBasedMatch');
  }
  /**
  ...
  public function get($matchId, $optParams = array())
  {
    $params = array('matchId' => $matchId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), 'Google\Service\Games\TurnBasedMatch');
  }
  /**
  ...
  public function join($matchId, $optParams = array())
  {
    $params = array('matchId' => $matchId);
    $params = array_merge($params, $optParams);
    return $this->call('join', array($params), 'Google\Service\Games\TurnBasedMatch');
  }
  /**
  ...
  public function leave($matchId, $optParams = array())
  {
    $params = array('matchId' => $matchId);
    $params = array_merge($params, $optParams);
    return $this->call('leave', array($params), 'Google\Service\Games\TurnBasedMatch');
  }
  /**
  ...
  public function leaveTurn($matchId, $matchVersion, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('leaveTurn', array($params), 'Google\Service\Games\TurnBasedMatch');
  }
  /**
   ...
   * @return \Google\Service\Games\TurnBasedMatchList
   */
  public function listTurnBasedMatches($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), 'Google\Service\Games\TurnBasedMatchList');
  }
  /**
   ...
   * @opt_param string language
   * The preferred language to use for strings returned by this method.
   * @return \Google\Service\Games\TurnBasedMatchRematch
   */
  public function rematch($matchId, $optParams = array())
  {
    $params = array('matchId' => $matchId);
    $params = array_merge($params, $optParams);
    return $this->call('rematch', array($params), 'Google\Service\Games\TurnBasedMatchRematch');
  }
  /**
   ...
   * True if match data should be returned in the response. Note that not all data will necessarily
    ...
    * the matches to limit download size for the client. The remainder of the data for these matches
    * will be retrievable on request.
   * @return \Google\Service\Games\TurnBasedMatchSync
   */
  public function sync($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('sync', array($params), 'Google\Service\Games\TurnBasedMatchSync');
  }
  /**
   ...
   * @return \Google\Service\Games\TurnBasedMatch
   */
  public function takeTurn($matchId, \Google\Service\Games\TurnBasedMatchTurn $postBody, $optParams = array())
  {
    $params = array('matchId' => $matchId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('takeTurn', array($params), 'Google\Service\Games\TurnBasedMatch');
  }
}
