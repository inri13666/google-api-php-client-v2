...
class Layers extends \Google\Resource\Service
{
   ...
   * @return \Google\Service\MapsEngine\Layer
   */
  public function create(\Google\Service\MapsEngine\Layer $postBody, $optParams = array())
  {
  ...
  public function get($id, $optParams = array())
  {
    $params = array('id' => $id);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), 'Google\Service\MapsEngine\Layer');
  }
  /**
   ...
   * @return \Google\Service\MapsEngine\LayersListResponse
   */
  public function listLayers($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), 'Google\Service\MapsEngine\LayersListResponse');
  }
  /**
   ...
   * The ID of the layer.
   * @param array $optParams Optional parameters.
   * @return \Google\Service\MapsEngine\PublishResponse
   */
  public function publish($id, $optParams = array())
  {
    $params = array('id' => $id);
    $params = array_merge($params, $optParams);
    return $this->call('publish', array($params), 'Google\Service\MapsEngine\PublishResponse');
  }
}
