...
class Maps extends \Google\Resource\Service
{
   ...
   * @return \Google\Service\MapsEngine\Map
   */
  public function create(\Google\Service\MapsEngine\Map $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), 'Google\Service\MapsEngine\Map');
  }
  /**
  ...
  public function get($id, $optParams = array())
  {
    $params = array('id' => $id);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), 'Google\Service\MapsEngine\Map');
  }
  /**
   ...
   * @return \Google\Service\MapsEngine\MapsListResponse
   */
  public function listMaps($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), 'Google\Service\MapsEngine\MapsListResponse');
  }
  /**
