...
class RasterCollections extends \Google\Resource\Service
{
   ...
   * @return \Google\Service\MapsEngine\RasterCollection
   */
  public function create(\Google\Service\MapsEngine\RasterCollection $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), 'Google\Service\MapsEngine\RasterCollection');
  }
  /**
  ...
  public function get($id, $optParams = array())
  {
    $params = array('id' => $id);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), 'Google\Service\MapsEngine\RasterCollection');
  }
  /**
   ...
   * @return \Google\Service\MapsEngine\RastercollectionsListResponse
   */
  public function listRasterCollections($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), 'Google\Service\MapsEngine\RastercollectionsListResponse');
  }
  /**
   ...
   * The ID of the raster collection.
   * @param array $optParams Optional parameters.
   * @return \Google\Service\MapsEngine\ProcessResponse
   */
  public function process($id, $optParams = array())
  {
    $params = array('id' => $id);
    $params = array_merge($params, $optParams);
    return $this->call('process', array($params), 'Google\Service\MapsEngine\ProcessResponse');
  }
}
